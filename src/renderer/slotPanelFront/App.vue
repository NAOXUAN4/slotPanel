...
<template>
  <div
    class="app-shell relative flex h-screen w-full flex-col overflow-hidden rounded-xl bg-[radial-gradient(circle_at_-10%_-10%,rgba(0,47,167,0.6)_0%,transparent_50%),radial-gradient(circle_at_110%_110%,rgba(34,211,238,0.2)_0%,transparent_60%)] bg-size-[200%_100%,50%_50%] bg-position-[top_left,bottom_right] bg-no-repeat font-mono shadow-[0_8px_32px_0_rgba(31,38,135,0.15)]"
  >
    <div
      class="title-bar drag-region flex h-8 w-full items-center justify-between px-4 py-3 font-mono backdrop-blur-sm transition-all duration-300 select-none"
    >
      <div class="title-bar-title flex flex-1 justify-end"></div>
      <div
        class="title-bar-btn no-drag flex w-35 justify-end gap-6 pt-1! pr-5! text-[#002FA7] opacity-60"
      >
